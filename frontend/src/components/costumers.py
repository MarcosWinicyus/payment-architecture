...
import requests
from src.requests.costumers import auth_costumer, delete_costumer
            ...
            with st.expander("", expanded=True):
                ...
                with col6:
                    ...
                    if delete_btn:
                        ...
                        st.button("Yes I'm want", on_click=delete_costumer, args=(
                            order["id"], ))
                        st.button("Cancel")
...
def costumers():
    ...
    if st.session_state["layout"] == 'list_costumers':
        list_costumers()
